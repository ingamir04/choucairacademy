...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanAmirWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorCalled("Amir").wasAbleTo(OpenUp.thePage(), (Login
    ...
    public void heSearchForTheCourseFoundationExpressOnTheChoucairAcademyPlatfrom(List<AcademyChoucairData> academyChoucairData) throws Exception {
